...
namespace ChallengeWebUI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddControllersWithViews();
            //var conn = @"Server=DESKTOP-E1T0HQ2; initial catalog=Challenge; integrated security=true";
            //services.AddDbContext<ChallengeProjectContext>(
